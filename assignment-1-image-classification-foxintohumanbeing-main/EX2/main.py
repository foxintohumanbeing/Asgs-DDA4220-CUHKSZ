    ...
    with torch.no_grad():
        for i, (image, annotation) in enumerate(val_loader):
            ...
            if i == 1:
                ...
                plt.savefig(r'C:\Users\mayn\Desktop\assignment-1-image-classification-foxintohumanbeing\pics\epoch'+str(epoch_num)+'.png')
...
if __name__ == '__main__':
    ...
    ### START SOLUTION HERE ###
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, gamma= 0.05,step_size = 5)
    ...
    for epoch in range(10):
        ...
        # save best model
        if acc > max_acc:
            pt_path = os.path.join('EX2/work_dir', 'EX2_best.pt')
    ...
    plt.savefig('C:/Users/mayn/Desktop/assignment-1-image-classification-foxintohumanbeing/pics/performancet.png')